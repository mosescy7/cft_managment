...
<link rel="icon" type="image/png" href="images/cft-icon.png">
<link rel="apple-touch-icon" href="images/cft-icon.png">
    ...
    <div class="prop-grid">
      <article class="prop-card reveal">
        <div class="prop-media"><span class="badge">Kimironko</span>
          <img src="images/kimironko-building.avif" alt="Exterior of the Inganji AP 19 building" loading="lazy"></div>
        <div class="prop-body">
          <h3>Inganji AP 19</h3>
      ...
      <article class="prop-card reveal">
        ...
        <div class="prop-body">
          ...
          <div class="prop-stats"><span class="stat">2 guests</span><span class="stat">1 bedroom</span><span class="stat">1 bed</span><span class="stat">1 bath</span></div>
          <p>A fully furnished one-bedroom apartment in Kimironko — living room, equipped kitchen and balcony with few minutes from the kimironko market.</p>
          <div class="prop-actions">
...
<section class="tight">
  <div class="wrap" style="max-width:640px">
    ...
    <p class="lead" style="margin-top:.6rem">Move-in-ready, furnished one-bedroom apartments located at 7 KG 168 Street, Kimironko.</p>
    </div>
    <div class="form-card reveal">
      ...
      <p style="font-size:.85rem;color:var(--ink-60);margin-top:1rem">Rent excludes utilities (water, electricity, trash and security) for 20,000 RWF per month.</p>
    ...
    <div class="prop-grid">
      <article class="prop-card reveal">
        ...
        <div class="prop-body">
          <h3>Inganji AP 19</h3>
          <div class="prop-stats"><span class="stat">2 guests</span><span class="stat">1 bedroom</span><span class="stat">1 bed</span><span class="stat">1 bath</span></div>
          <p>A calm, comfortable one-bedroom apartment in the heart of Kimironko — furnished, an equipped kitchen, living room and balcony, minutes from the Kimironko Market.</p>
          <div class="prop-actions">
...
<main>
<section class="hero compact" style="padding:0">
  <img class="hero-bg" src="images/imena-building-day.jpg" alt="Imena Estate — CFT's mixed-use building with commercial shops and apartments">
  <div class="wrap hero-inner">
    <div class="frame">
...
<section>
  <div class="wrap split">
    ...
    <div class="img-frame reveal"><img src="images/imena-storefront-night.jpg" alt="Imena Estate ground-floor storefronts at night" loading="lazy"></div>
  </div>
</section>
    ...
    <div class="prop-grid">
      <article class="prop-card reveal">
        <div class="prop-media"><span class="badge">Available</span>
          <img src="images/imena-storefront-night.jpg" alt="Ground-floor shop SH9 at Imena Estate" loading="lazy"></div>
        <div class="prop-body">
          <h3>Shop 9 (SH9) — Ground Floor</h3>
          <div class="prop-stats"><span class="stat">± 65 m²</span><span class="stat">Street facing</span><span class="stat">Parking</span></div>
          <p>Our largest ground-floor unit at Imena Estate, Kimironko — excellent visibility, water, electricity and 24/7 security included.</p>
          <div class="prop-actions">
            <a class="btn btn-green" href="contact.html">Inquire About This Space</a>
            <a class="btn btn-whatsapp" href="https://wa.me/{WA}?text=Hello%2C%20I%27m%20interested%20in%20Shop%209%20(SH9)%20at%20Imena%20Estate." target="_blank" rel="noopener">WhatsApp</a>
          </div>
        </div>
      </article>
    </div>
    <p style="text-align:center;margin-top:1.6rem;color:var(--ink-60);font-size:.9rem">All other commercial units at Imena Estate are currently occupied — message us on WhatsApp to join the waiting list.</p>
  </div>
</section>
